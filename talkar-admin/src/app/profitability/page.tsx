...
export default function ProfitabilityPage() {
  ...
  const overrides = (() => {
    try { return JSON.parse(globalSettingsInput || "{}"); } catch { return {}; }
  })();
  ...
  const setOverride = (key: string, value: string) => {
    ...
    setGlobalSettingsInput(JSON.stringify(newOverrides, null, 2));
  };
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      type="number" step="0.01" placeholder="Default: 0.60"
                  ...
                  <div>
                    ...
                    <input 
                      type="number" step="0.1" placeholder="Default: 95.7"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      type="number" step="0.0001" placeholder="Default: 0.0048"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
                  ...
                  <div>
                    ...
                    <input 
                      type="number" step="0.0001" placeholder="Default: 0.003"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      type="number" step="0.001" placeholder="Default: 0.18"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
                  ...
                  <div>
                    ...
                    <input 
                      type="number" step="0.001" placeholder="Default: 0.015"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
                  ...
                  <div>
                    ...
                    <input 
                      type="number" step="0.001" placeholder="Default: 0.0175"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input 
                      type="number" step="0.01" placeholder="Default: 0.15"
                      className="w-full h-8 px-2.5 mt-1.5 border border-slate-200 rounded text-xs bg-white focus:outline-none focus:border-slate-400 transition-colors shadow-sm"
